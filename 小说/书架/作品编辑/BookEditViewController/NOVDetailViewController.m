...
- (void)viewDidLoad {
    ...
    switch (self.viewtype) {
        ...
        case 1:
            ...
            break;
        case 2:
            titleArray = @[@"公开",@"我的粉丝",@"我的好友"];
            detailArray = @[@"所有人可参与续写",@"我的粉丝可参与续写",@"互相关注可参与续写"];
            break;
        case 3:
            titleArray = @[@"公开",@"我的粉丝",@"我的好友"];
            detailArray = @[@"所有人可见",@"我的粉丝可见",@"互相关注的人可见"];
            break;
        default:
            break;
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (selectCell == -1) {//未选择，改变选择类型的颜色
        NOVDetailTableViewCell *cell = (NOVDetailTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
        cell.imageView.image = [UIImage imageNamed:@"圈2.png"];
        selectCell = indexPath.row;
    } else if (indexPath.row != selectCell){//已经选择过，改变所选类型
