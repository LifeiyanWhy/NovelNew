...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [self setRightViewButton:_followButton imageTitle:@"关注read"];
        
        _collectionButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [rightView addSubview:_collectionButton];
        [self setRightViewButton:_collectionButton imageTitle:@"收藏read"];
        
        _commentButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [rightView addSubview:_commentButton];
        [self setRightViewButton:_commentButton imageTitle:@"评论read"];
...
-(void)layoutSubviews{
    ...
    [_backButton setImage:[UIImage imageNamed:@"返回read.png"] forState:UIControlStateNormal];
    ...
    [_rightButton setImage:[UIImage imageNamed:@"点.png"] forState:UIControlStateNormal];
    ...
    [_partButton setImage:[UIImage imageNamed:@"眼睛read.png"] forState:UIControlStateNormal];
    ...
    [_nightButton setImage:[UIImage imageNamed:@"夜间read.png"] forState:UIControlStateNormal];
