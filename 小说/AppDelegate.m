...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    sjNavigation.tabBarItem.selectedImage = [[UIImage imageNamed:@"书架-2.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    myNavigation.tabBarItem.selectedImage = [[UIImage imageNamed:@"账户-2.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
